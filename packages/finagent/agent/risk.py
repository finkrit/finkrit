...
RISK_INSTRUCTIONS = (
    ...
    "benchmark where relevant. When the user does not name a benchmark, do not "
    "ask for one: omit benchmark_ticker and the tools use the S&P 500 (^GSPC), "
    "then say that is the benchmark you used. "
    "Volatility and related measures are annualized. "
