<script lang="ts">
	// Minimal inline-SVG icon set. Add a path to PATHS to add an icon; keeps us
	// off an icon-font dependency for the handful we need.
	type IconName =
		| 'chevron'
		| 'close'
		| 'send'
	...
	const PATHS: Record<IconName, string> = {
		...
		risk: 'M4 19V5M4 19h16M8 15l3-4 3 2 4-6',
		...
		leaf: 'M5 19c0-8 5-13 14-14-1 9-6 14-14 14zM5 19c3-3 6-6 9-9',
		scale: 'M12 3v18M8 21h8M12 6L5 8l2.5 6a3 3 0 0 1-5 0L5 8M12 6l7 2-2.5 6a3 3 0 0 0 5 0L19 8'
	};
</script>
